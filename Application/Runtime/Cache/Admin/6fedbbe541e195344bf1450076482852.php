...
<head>
  ...
  <title>Amaze后台管理系统模板HTML首页 - JS代码网</title>
  <meta name="description" content="这是一个 index 页面">
  <meta name="keywords" content="index">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
  <meta name="renderer" content="webkit">
  <meta http-equiv="Cache-Control" content="no-siteapp" />
  <link rel="icon" type="image/png" href="/tp/Public/assets/i/favicon.png">
  <link rel="apple-touch-icon-precomposed" href="/tp/Public/assets/i/app-icon72x72@2x.png">
  <meta name="apple-mobile-web-app-title" content="Amaze UI" />
  <link rel="stylesheet" href="/tp/Public/assets/css/amazeui.min.css"/>
  <link rel="stylesheet" href="/tp/Public/assets/css/admin.css">
</head>
<body>
<!--[if lte IE 9]>
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list">
      ...
      <li class="am-dropdown" data-am-dropdown>
        ...
        <ul class="am-dropdown-content">
          ...
          <li><a href="<?php echo U('logout','','');?>"><span class="am-icon-power-off"></span> 退出</a></li>
        </ul>
      </li>
    ...
    <ul class="am-list admin-sidebar-list">
      ...
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
          <li><a href="<?php echo U('profile');?>" class="am-cf"><span class="am-icon-check"></span> 个人资料<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
          <li><a href="<?php echo U('help');?>"><span class="am-icon-puzzle-piece"></span> 帮助页</a></li>
          <li><a href="<?php echo U('gallery');?>"><span class="am-icon-th"></span> 相册页面<span class="am-badge am-badge-secondary am-margin-right am-fr">24</span></a></li>
          <li><a href="<?php echo U('log');?>"><span class="am-icon-calendar"></span> 系统日志</a></li>
          <li><a href="<?php echo U('error');?>"><span class="am-icon-bug"></span> 404</a></li>
        </ul>
      </li>
      <li><a href="<?php echo U('table');?>"><span class="am-icon-table"></span> 表格</a></li>
      <li><a href="<?php echo U('form');?>"><span class="am-icon-pencil-square-o"></span> 表单</a></li>
      <li><a href="<?php echo U('logout','','');?>"><span class="am-icon-sign-out"></span> 注销</a></li>
    </ul>
        ...
        <div class="am-panel am-panel-default">
          ...
          <div id="collapse-panel-2" class="am-in">
            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
              ...
              <tr>
                <td class="am-text-center"><img src="/tp/Public/assets/i/examples/admin-chrome.png" alt=""></td>
                <td>Google Chrome</td>
                <td>3,005</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="/tp/Public/assets/i/examples/admin-firefox.png" alt=""></td>
                <td>Mozilla Firefox</td>
                <td>2,505</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="/tp/Public/assets/i/examples/admin-ie.png" alt=""></td>
                <td>Internet Explorer</td>
                <td>1,405</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="/tp/Public/assets/i/examples/admin-opera.png" alt=""></td>
                <td>Opera</td>
                <td>4,005</td>
              </tr>
              <tr>
                <td class="am-text-center"><img src="/tp/Public/assets/i/examples/admin-safari.png" alt=""></td>
                <td>Safari</td>
                <td>505</td>
              </tr>
              </tbody>
...
<script src="/tp/Public/assets/js/polyfill/rem.min.js"></script>
<script src="/tp/Public/assets/js/polyfill/respond.min.js"></script>
<script src="/tp/Public/assets/js/amazeui.legacy.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="/tp/Public/assets/js/jquery.min.js"></script>
<script src="/tp/Public/assets/js/amazeui.min.js"></script>
<!--<![endif]-->
<script src="/tp/Public/assets/js/app.js"></script>
</body>
</html>