...
u1=splash_url+"/splash?form_file=fdf/splash.fdf&dn="+dn+"&lang="+lang;u2=seal_url+"/getseal?at=0&sealid=0&dn="+dn+"&lang="+lang+"&tpt="+tpt;u3=seal_url+"/getseal?at=1&sealid=0&dn="+dn+"&lang="+lang+"&tpt="+tpt;var u5=sslcenter_url;var sopener;function symcBuySSL(){var win=window.open(u5,'_blank');win.focus();}
...
if(MM_play){document.write('<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"');document.write('  codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0"');document.write(' ID="s_l" WIDTH="130" HEIGHT="88" ALIGN="">');document.write(' <PARAM NAME=movie VALUE="'+u3+'"> <PARAM NAME=loop VALUE=false> <PARAM NAME=menu VALUE=false> <PARAM NAME=quality VALUE=best> <PARAM NAME=wmode VALUE='+tpt+'> <PARAM NAME="allowScriptAccess" value="always">');document.write(' <EMBED src="'+u3+'" loop=false menu=false quality=best wmode='+tpt);document.write(' swLiveConnect=FALSE WIDTH="130" HEIGHT="88" NAME="s_l" ALIGN=""');document.write(' TYPE="application/x-shockwave-flash" PLUGINSPAGE="https://www.macromedia.com/go/getflashplayer" allowScriptAccess="always">');document.write(' </EMBED>');document.write(' </OBJECT>');}else{document.write("<a HREF=\"javascript:vrsn_splash()\" tabindex=\"-1\"><IMG NAME=\"seal\" BORDER=\"true\" SRC=\""+u2+"\" oncontextmenu=\"return false;\" alt=\"Click to Verify - This site has chosen an SSL Certificate to improve Web site security\"></A>");if(document.addEventListener){document.addEventListener('mouseup',v_mact,true);}
